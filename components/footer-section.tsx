...
export function FooterSection() {
  return (
    <footer className="w-full border rounded-t-2xl bg-transparent max-w-[1320px] mx-auto px-5 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-0 py-10 md:py-[70px]">
      ...
      />
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-white/5 to-transparent rounded-t-2xl" />
    </footer>
  );
}
